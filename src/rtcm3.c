...
extern int decode_rtcm3(rtcm_t *rtcm)
{
    ...
    switch (type) {
        ...
        case 1057: ret=decode_ssr1(rtcm,SYS_GPS); break; /* GPS orb       */
        case 1058: ret=decode_ssr2(rtcm,SYS_GPS); break; /*     clk       */
        case 1059: ret=decode_ssr3(rtcm,SYS_GPS); break; /*     cbias     */
        case 1060: ret=decode_ssr4(rtcm,SYS_GPS); break; /*     orb/clk   */
        case 1061: ret=decode_ssr5(rtcm,SYS_GPS); break; /*     URA       */
        case 1062: ret=decode_ssr6(rtcm,SYS_GPS); break; /*     HRorb/clk */
        case 1063: ret=decode_ssr1(rtcm,SYS_GLO); break; /* GLO orb       */
        case 1064: ret=decode_ssr2(rtcm,SYS_GLO); break; /*     clk       */
        case 1065: ret=decode_ssr3(rtcm,SYS_GLO); break; /*     cbias     */
        case 1066: ret=decode_ssr4(rtcm,SYS_GLO); break; /*     orb/clk   */
        case 1067: ret=decode_ssr5(rtcm,SYS_GLO); break; /*     URA       */
        case 1068: ret=decode_ssr6(rtcm,SYS_GLO); break; /*     HRorb/clk */
        ...
        case 1240: ret=decode_ssr1(rtcm,SYS_GAL); break; /* GAL orb       */
        case 1241: ret=decode_ssr2(rtcm,SYS_GAL); break; /*     clk       */
        case 1242: ret=decode_ssr3(rtcm,SYS_GAL); break; /*     cbias     */
        case 1243: ret=decode_ssr4(rtcm,SYS_GAL); break; /*     orb/clk   */
        case 1244: ret=decode_ssr5(rtcm,SYS_GAL); break; /*     URA       */
        case 1245: ret=decode_ssr6(rtcm,SYS_GAL); break; /*     HRorb/clk */
        case 1246: ret=decode_ssr1(rtcm,SYS_QZS); break; /* QZS orb       */
        case 1247: ret=decode_ssr2(rtcm,SYS_QZS); break; /*     clk       */
        case 1248: ret=decode_ssr3(rtcm,SYS_QZS); break; /*     cbias     */
        case 1249: ret=decode_ssr4(rtcm,SYS_QZS); break; /*     orb/clk   */
        case 1250: ret=decode_ssr5(rtcm,SYS_QZS); break; /*     URA       */
        case 1251: ret=decode_ssr6(rtcm,SYS_QZS); break; /*     HRorb/clk */
        case 1252: ret=decode_ssr1(rtcm,SYS_SBS); break; /* SBS orb       */
        case 1253: ret=decode_ssr2(rtcm,SYS_SBS); break; /*     clk       */
        case 1254: ret=decode_ssr3(rtcm,SYS_SBS); break; /*     cbias     */
        case 1255: ret=decode_ssr4(rtcm,SYS_SBS); break; /*     orb/clk   */
        case 1256: ret=decode_ssr5(rtcm,SYS_SBS); break; /*     URA       */
        case 1257: ret=decode_ssr6(rtcm,SYS_SBS); break; /*     HRorb/clk */
        case 1258: ret=decode_ssr1(rtcm,SYS_CMP); break; /* BDS orb       */
        case 1259: ret=decode_ssr2(rtcm,SYS_CMP); break; /*     clk       */
        case 1260: ret=decode_ssr3(rtcm,SYS_CMP); break; /*     cbias     */
        case 1261: ret=decode_ssr4(rtcm,SYS_CMP); break; /*     orb/clk   */
        case 1262: ret=decode_ssr5(rtcm,SYS_CMP); break; /*     URA       */
        case 1263: ret=decode_ssr6(rtcm,SYS_CMP); break; /*     HRorb/clk */
